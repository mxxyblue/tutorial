...
<div id="wrap">
	...
	<div id="container">
		...
		<table class="table table-hover" style="width: 600px;">
			...
			<tr>
				<td colspan="3">
					<input type="button" value="수정" class="btn btn-default" onclick="calUpdate()"/>
					<input type="button" value="삭제" class="btn btn-default" onclick="mulDel(${dto.cseq})"/>
					<input type="button" value="목록" class="btn btn-default" onclick="calList()"/>
				</td>
			</tr>
		</table>
		</div>
